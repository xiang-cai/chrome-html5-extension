...
~function(cscope) {
    ...
    var alternateElement, alternateHTML;
...
//			flagElement.parentNode.removeChild(flagElement);
			p = alternateElement.parentNode;
			
			curHTML = alternateElement.innerHTML;
			alternateElement.innerHTML = alternateHTML;

//			p.removeChild(replacedElement);
//			p.appendChild(replacedElement);
			p.replaceChild(alternateElement, alternateElement);
			
			alternateHTML = curHTML;
	   }
	});
    ...
    function launchPlayer(element, url, success) {
      ...
      //  '</video>';
		...
		alternateHTML = element.innerHTML;
